...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/affiliations", destination: "/about-us", permanent: true },
      { source: "/opportunity", destination: "/careers", permanent: true },
      { source: "/psychometric-assessments", destination: "/services/psychometric-assessments", permanent: true },
      { source: "/clinical-assessments", destination: "/services/clinical-assessments", permanent: true },
