      ...
      <div className="flex flex-col flex-1 py-6 px-2">
        ...
        <div className="relative mt-2 mb-6">
          <div className="flex items-center gap-2 mb-2">
            <span className="w-1 h-3 bg-[#7A9A7D]/30 rounded-full" />
            <span className="text-[8px] font-bold uppercase tracking-[0.2em] text-black/30">Expert Insight</span>
          </div>
          <p className="text-lg font-serif italic text-black/80 leading-snug line-clamp-4">
            &ldquo;{specialist.teaser}&rdquo;
          </p>
        </div>
