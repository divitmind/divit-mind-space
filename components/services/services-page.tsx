        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <div className="w-px h-8 bg-black/10" />
              <div className="text-center">
                <div className="text-xl font-serif italic text-green leading-none" style={{ fontFamily: "'Cormorant Garamond', 'Georgia', serif" }}>4.9 / 5</div>
                <div className="text-[9px] text-black/50 font-bold uppercase tracking-widest mt-1">Google</div>
              </div>
            </motion.div>
          </div>
        </div>
