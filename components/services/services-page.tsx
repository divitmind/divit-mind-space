...
const categoryDescriptions: Record<string, string> = {
  ...
  assessments: "Professional evaluations to understand your child's unique needs and create a clear path forward.",
  therapy: "Speech, occupational, and behavioral therapy to build confidence, communication, and essential life skills.",
  guidance: "Expert counseling and training programs for parents, educators, and caregivers.",
  programs: "Structured early intervention, special education, and school readiness programs.",
};
...
export default function ServicesPage({ title = "Our Services", services }: ServicesPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7]">
      {/* Hero Section */}
      <section className="pt-10 lg:pt-16 pb-6 lg:pb-10 bg-[#FDFBF7]">
      ...
      <section id="category-tabs" className="py-4 bg-[#FDFBF7] sticky top-20 z-40 border-y border-black/5">
        <div className="container mx-auto px-4 relative">
          ...
          <div className="absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-[#FDFBF7] to-transparent z-10 pointer-events-none md:hidden" />
          
          <div className="flex overflow-x-auto no-scrollbar md:flex-wrap items-center md:justify-center gap-3 pb-2 md:pb-0">
            {categories.map((cat) => {
      ...
      {/* Bottom CTA */}
      <section className="pt-2 lg:pt-4 pb-10 lg:pb-16 bg-[#FDFBF7]">
        <div className="container mx-auto px-4">
          <motion.div
          ...
          >
            <h2
              ...
              style={{ fontFamily: "'Cormorant Garamond', 'Georgia', serif" }}
            >
              Bangalore&apos;s Leading Center for Holistic Support
            </h2>
            <p className="text-black/70 mb-10 text-lg font-medium">
              Experience professional excellence in mental health, neurodevelopment, and physiotherapy. Book a free consultation to discuss our specialized education and counseling services tailored for all ages.
            </p>
