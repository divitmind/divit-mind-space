            ...
            <div className="container">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 stagger-children">
                    {services.map((service) => (
                        ...
                        >
                            {/* Icon - Light Warm Beige (matching reference) */}
                            <div className={cn(
                                "w-12 h-12 rounded-full flex items-center justify-center mb-8 transition-all duration-500 group-hover:bg-[#EDE5D8] group-hover:scale-110",
                                service.iconBg
                            )}>
                                <service.icon className={cn("h-5 w-5 text-[#8B7355] transition-transform duration-500 group-hover:scale-105")} />
                            </div>
