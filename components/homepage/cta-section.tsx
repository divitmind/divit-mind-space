        ...
        <section className="pt-2 pb-2 lg:pt-4 lg:pb-4 bg-[#FDFBF7] px-4">
            <div className="container">
                <motion.div
                    ...
                    className="max-w-5xl mx-auto bg-white rounded-[2rem] md:rounded-[2.5rem] border border-black/5 p-6 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12 shadow-2xl shadow-black/[0.03]"
                >
