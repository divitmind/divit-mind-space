        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-4">
          ...
          <div className="flex-[1.2] text-center lg:text-left animate-in slide-in-from-bottom duration-700 fade-in">
            ...
            <div className="mt-4 flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              <WhatsAppConsultationLink className="inline-flex items-center justify-center gap-2 h-11 px-6 rounded-full bg-[#004540] text-sm font-semibold text-white shadow-xl shadow-[#004540]/30 hover:bg-[#003835] hover:shadow-2xl hover:shadow-[#004540]/40 transition-all duration-300">
