...
export function HeroSection({ announcement, siteSettings }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden pt-2 pb-4 md:pt-6 md:pb-8 lg:pt-4 lg:pb-10 min-h-[auto] md:min-h-[450px] lg:min-h-[500px] flex items-start">
      <div className="container relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-4 lg:gap-4">
          ...
          <div className="flex-[1.2] text-center md:text-left animate-in slide-in-from-bottom duration-700 fade-in">
            ...
            <div className="flex flex-col w-full max-w-[540px] mx-auto md:mx-0 mt-3 sm:mt-4">
              <h1 className="flex flex-col tracking-tight text-black leading-none text-[clamp(2.5rem,7vw,5.5rem)]">
                {/* Line 1: EMPOWERING EVERY CHILD'S with overlapping yellow strokes */}
                <span className="relative flex justify-center md:justify-start items-center md:items-baseline gap-x-1 lg:gap-x-2 w-full text-[clamp(0.9rem,2vw,1.6rem)] font-bold uppercase tracking-[0.12em] mb-3 py-1 px-2">
                  ...
                  <span className="flex"><span>E</span><span>M</span><span>P</span><span>O</span><span>W</span><span>E</span><span>R</span><span>I</span><span>N</span><span>G</span></span>
                  <span className="ml-1.5 flex"><span>E</span><span>V</span><span>E</span><span>R</span><span>Y</span></span>
                  {/* Rolling audience: CHILD'S → TEEN'S → ADULT'S → FAMILY'S */}
                  <span className="ml-1.5 relative inline-flex font-extrabold">
                  ...
                  <span className="flex justify-center md:justify-start items-center md:items-baseline gap-[1.125rem] sm:gap-4 text-[clamp(2rem,6vw,4rem)] font-[family-name:var(--font-cormorant)] italic text-[#7A9A7D] leading-[0.9] -mt-1 font-medium">
          ...
          <div className="hidden md:block flex-1 w-full max-w-sm sm:max-w-md lg:max-w-xl relative animate-in slide-in-from-right duration-1000 fade-in delay-200">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-lg mx-auto md:mr-0 aspect-square md:aspect-[5/4] max-w-[480px] lg:max-w-none border-4 border-[#FAF7F2]">
              <Image
                src={heroImage}
                alt={heroImageAlt}
            ...
            <div className="absolute -bottom-10 right-0 w-64 h-64 bg-[#7A9A7D]/15 rounded-full blur-3xl -z-10" />
          </div>
        </div>
      </div>
    </section>
