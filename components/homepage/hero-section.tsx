        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-4">
          ...
          <div className="flex-[1.2] text-center lg:text-left animate-in slide-in-from-bottom duration-700 fade-in">
            ...
            <div className="mt-4 flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              <WhatsAppConsultationLink className="inline-flex h-11 items-center justify-center rounded-full border-2 border-[#722F37] px-6 text-sm font-bold text-[#722F37] shadow-md shadow-[#722F37]/15 hover:bg-[#722F37] hover:text-white hover:shadow-lg hover:shadow-[#722F37]/25 transition-all">
              ...
              <Link
                ...
                className="inline-flex h-11 items-center justify-center px-6 rounded-full border border-green text-sm font-semibold text-green hover:bg-green/5 transition-all duration-300"
              >
