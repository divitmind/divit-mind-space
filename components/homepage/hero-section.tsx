        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-4">
          ...
          <div className="flex-[1.2] text-center lg:text-left animate-in slide-in-from-bottom duration-700 fade-in">
            ...
            <div className="flex flex-col w-full max-w-[580px] mx-auto lg:mx-0 mt-7">
              <h1 className="flex flex-col tracking-tight text-black leading-none">
                ...
                <span className="relative flex justify-between items-baseline w-full text-[clamp(0.9rem,2.2vw,1.6rem)] font-bold uppercase tracking-[0.12em] mb-3 py-1 px-2">
                  {/* Multiple overlapping highlight strokes - sage green */}
                  <span className="absolute inset-0 bg-[#89A09E]/25 -z-10 rounded-sm transform -rotate-[1.5deg] scale-x-[1.08] -translate-x-0.5" />
                  <span className="absolute inset-0 bg-[#89A09E]/30 -z-10 rounded-sm transform rotate-[0.8deg] scale-x-[1.04] translate-y-px" />
                  <span className="absolute inset-0 bg-[#89A09E]/20 -z-20 rounded-sm transform -rotate-[0.5deg] scale-x-[1.06] scale-y-[1.15] -translate-y-px" />
            ...
            <div className="mt-8 flex flex-col items-center lg:items-start gap-3">
              <WhatsAppConsultationLink className="dm-hero-button">
              ...
              {/* Secondary link for schools/organizations */}
              <Link
                href="/awareness-program"
                className="group inline-flex items-center gap-1.5 text-sm text-black/50 hover:text-[#7A9A7D] transition-colors"
              >
