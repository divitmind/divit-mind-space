    ...
    <div className="min-h-screen bg-[#FAF9F5]">
      ...
      <section className="pt-2 pb-2 lg:pt-4 lg:pb-4 bg-[#FAF9F5] px-4">
        <div className="container mx-auto">
          <InlineCtaBlock
            heading="Want to host a session?"
            subtext="We design free sessions for schools, colleges, corporates, hospitals and apartment communities. Message us on WhatsApp with your audience details."
          />
        </div>
      </section>
    </div>
