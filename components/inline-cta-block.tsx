...
// Shared inline CTA block — matches the voice and styling of <CtaSection /> in
...
export function InlineCtaBlock({
  ...
  subtext = "Message us on WhatsApp — ask us anything, we'll answer your questions.",
}: {
  heading?: string;
  subtext?: string;
}) {
  return (
    <div className="max-w-2xl mx-auto text-center bg-white rounded-[2rem] border border-black/5 shadow-xl shadow-black/[0.02] p-8 lg:p-10">
      ...
      <p className="text-black/60 font-medium mb-6">{subtext}</p>
