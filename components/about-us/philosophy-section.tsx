...
import { Heart, Users, Brain, Shield, Sparkles, Clock } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-green/60 max-w-xl mx-auto">
            What sets Divit MindSpace apart from other centers
          </p>
        </motion.div>
          ...
          {reasons.map((reason, idx) => (
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-purple/10 flex items-center justify-center mb-4">
                <reason.icon className="w-5 h-5 text-purple" />
              </div>
