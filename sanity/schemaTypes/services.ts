...
export const servicesType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'image',
      group: 'basic',
      description: '📐 RECOMMENDED: 800×600px (4:3 ratio) or larger. MIN: 400×300px. Use hotspot to set focal point on faces/key areas so cropping looks good on all devices.',
    ...
    defineField({
      ...
      fields: [
        ...
        },
        {
          ...
          description: '📐 Use 1200×630px for best results on Facebook/Twitter. Falls back to service image if blank.',
          options: {hotspot: true},
        },
      ],
    }),
